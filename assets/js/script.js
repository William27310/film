...
if (movie !== null && (typeof movie !== 'object')) {
    fetch(`https://api.themoviedb.org/3/search/movie?query=${movie}&include_adult=false&language=fr-fr&page=1`, options)
        ...
        .then(data => {
            ...
            <div class="card border border-dark p-0" style="width: 18rem;">
                ...
                <div class="card-body">
                    <a class="text-decoration-none text-white" href="casting_film.html?id=${data.results[i].id}"><h5 class="mt-2">${data.results[i].title}</h5></a>
